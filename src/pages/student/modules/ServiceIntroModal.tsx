...
// Service Guide Data for intro modals
...
function ServiceIntroModal({ serviceKey }: any) {
    ...
    return (
        <div className="student-service-intro fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-backdrop">
            <div className="student-service-intro__panel bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden animate-scale-in">
                {/* Header */}
                <div className={`student-service-intro__header px-8 py-6 bg-gradient-to-r ${guide.color} text-white relative overflow-hidden`}>
                    <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-10 -mt-10 blur-2xl" />
                    <div className="absolute bottom-0 left-0 w-28 h-28 bg-white/10 rounded-full -ml-10 -mb-10 blur-xl" />
                ...
                {/* Steps */}
                <div className="p-8">
                    <h4 className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.18em] mb-4">How it works</h4>
                    <div className="space-y-3 mb-6">
                        {guide.steps.map((step: any, idx: number) => (
                            <div key={idx} className="student-service-intro__step flex items-start gap-3 p-3 bg-gray-50 rounded-xl">
