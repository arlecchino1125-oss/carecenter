...
export default function StudentDashboardModule({ p }: { p: any }) {
    const { activeView, personalInfo, activeVisit, handleOfficeTimeOut, handleOfficeTimeIn, notifications, eventsList, setActiveView, attendanceMap, colorMap, Icons } = p;

    return (
        <>                    {activeView === 'dashboard' && (
                        <div className="student-module student-dashboard-module space-y-8 page-transition">
                            {/* Hero Banner (Optimized) */}
                            <StudentHero firstName={personalInfo.firstName} />
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                <div className="lg:col-span-2 space-y-6">
                                    <div className="student-surface-card bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-100/50 p-6 shadow-sm card-hover animate-fade-in-up" style={{ animationDelay: '100ms' }}>
                                    ...
                                    <div className="student-surface-card bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-100/50 p-6 shadow-sm card-hover animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="student-surface-card bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-100/50 p-6 shadow-sm card-hover animate-fade-in-up" style={{ animationDelay: '400ms' }}>
