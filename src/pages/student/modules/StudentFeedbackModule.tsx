...
export default function StudentFeedbackModule({ p }: { p: any }) {
    const { activeView, Icons, personalInfo } = p;
...
function FeedbackView({ Icons, personalInfo }: { Icons: any; personalInfo: any }) {
    ...
    if (submitted) {
        return (
            <div className="student-module student-feedback-module page-transition max-w-3xl mx-auto">
                <div className="student-surface-card bg-white/90 backdrop-blur-sm rounded-2xl border border-green-100/50 p-12 text-center shadow-sm animate-fade-in-up">
    ...
    return (
        <div className="student-module student-feedback-module page-transition max-w-4xl mx-auto space-y-6">
            {/* CSM Header */}
            ...
            {/* Client Info Section */}
            <div className="student-surface-card bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-100/50 p-8 shadow-sm animate-fade-in-up" style={{ animationDelay: '80ms' }}>
            ...
            <div className="student-surface-card bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-100/50 p-8 shadow-sm animate-fade-in-up" style={{ animationDelay: '160ms' }}>
            ...
            {/* Open-ended Section */}
            <div className="student-surface-card bg-white/90 backdrop-blur-sm rounded-2xl border border-blue-100/50 p-8 shadow-sm animate-fade-in-up" style={{ animationDelay: '320ms' }}>
                ...
                {loadingHistory ? <p className="text-xs text-gray-400">Loading...</p> : myFeedbacks.length === 0 ? (
                    ...
                    <div className="space-y-3">
                        {myFeedbacks.map((fb: any, idx: number) => {
                            ...
                            return (
                                <div key={fb.id} onClick={() => setViewingFeedback(fb)} className="student-surface-card bg-white/90 backdrop-blur-sm rounded-xl border border-blue-100/50 p-5 shadow-sm cursor-pointer hover:shadow-md hover:border-blue-200 transition-all flex justify-between items-center" style={{ animationDelay: `${idx * 60}ms` }}>
                                    <div>
            ...
            {viewingFeedback && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="student-modal-surface bg-white rounded-2xl w-full max-w-2xl shadow-2xl max-h-[90vh] overflow-y-auto animate-fade-in-up">
